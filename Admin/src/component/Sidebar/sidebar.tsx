...
const NAV_PERMISSIONS: Record<string, string[]> = {
  ...
  cms: ["view-blog-list", "view-faq-list", "view-sponsor-list", "view-social-link-list", "view-home-slider-list", "view-media-list", "view-contact-list", "view-cms-page-list", "view-glimpse-list"],
  faq: ["view-faq-list"],
  sponsors: ["view-sponsor-list"],
  "social-links": ["view-social-link-list"],
  "home-slider": ["view-home-slider-list"],
  blog: ["view-blog-list"],
  media: ["view-media-list"],
  "contact-us": ["view-contact-list"],
  "cms-pages": ["view-cms-page-list"],
  "glimpse": ["view-glimpse-list"],
