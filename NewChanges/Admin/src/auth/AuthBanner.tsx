...
const AuthBanner = () =>{
    ...
    return(
        ...
        <div className="relative overflow-hidden h-52">
            ...
            <div className="absolute inset-e-0 bottom-0 top-0 flex flex-col justify-between md:max-w-70 max-w-60 md:p-4 p-4 bg-[linear-gradient(270deg,#FFFFFF_0%,rgba(255,255,255,0.729193)_49.47%,rgba(255,255,255,0)_100%)]
            rtl:bg-[linear-gradient(90deg,#FFFFFF_0%,rgba(255,255,255,0.729193)_49.47%,rgba(255,255,255,0)_100%)]">
              <Heading variant="h3" className="font-bold text-secondary">
                {t.login.unlockAthlete}
                <br />
                {t.login.athleteWithin}
              </Heading>
              <Text
                variant="textBase"
